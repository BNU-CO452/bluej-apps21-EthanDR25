...
public class StockList
{
    ...
    /**
     * This is the method for removing a product from the stocklist of
     * products.
     */
     ...
     * using a feature within a java library to assign random 
     * values to all of the products.
     */
    ...
    public void printProductsWithLowStock()
    {
        ...
        {
            if(product.getQuantity() > lowStockValue && product.getQuantity() < 5)
            {
